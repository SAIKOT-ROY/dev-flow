...
import hamburgerMenu from '@/public/assets/icons/hamburger.svg'
        ...
        <Sheet>
            ...
            <SheetContent side="left"
                ...
                <Link href="/" className='flex items-center gap-1'>
                    ...
                    <p className='h2-bold font-spaceGrotesk text-dark100_light900'>Dev <span className='text-primary-50'>Overflow</span></p>
                </Link>
                <div>
                    <SheetClose asChild>
                        <NavContent />
