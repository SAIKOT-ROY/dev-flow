            ...
            <div>
                ...
                <div className='mt-7 flex w-full flex-col gap-[30px]'>
                    {hotQuestions.map((question) => (
                        <Link href={`/question/${question._id}`} key={question._id} className='flex cursor-pointer items-center justify-between gap-7'>
                            <p className='body_medium text-dark500_light700'>{question.title}</p>
                            <Image
                                src={chevron}
                                alt="chevron right"
                                width={20}
